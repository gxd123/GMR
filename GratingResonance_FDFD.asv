...
SRC.MODE = 'E';                   % EM mode
f0 = c0/SRC.lam0;
lam01 = 2.00 * micrometers;
lam02 = 1.00 * micrometers;
...
d    = 0.5000*lamd;             % Grating depth
t    = 1.0000*lamd;             % Substrate thickness
...
for n = 1:Nf
    ...
    clc;
    time = toc;
    disp(['Estimated Time: ' num2str(time*(Nf-n)/60) ' minutes']);
...
xlim([lam0(end) lam0(1)]./micrometers); ylim([0 102]);
